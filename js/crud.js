    ...
    methods: {
        btnCrear: async function() {
            ...
            const {value: formValues} = await Swal.fire({
                title: 'NUEVO',
                html:
                '<div class="row"><label class="col-sm-3 col-form-label">ejercicio</label><div class="col-sm-7"><input id="ejercicio" type="text" class="form-control"></div></div><div class="row"><label class="col-sm-3 col-form-label">cantrepeticiones</label><div class="col-sm-7"><input id="cantrepeticiones" type="number" class="form-control"></div></div><div class="row"><label class="col-sm-3 col-form-label">cantseries</label><div class="col-sm-7"><input id="cantseries" type="number" min="0" class="form-control"></div></div><div class="row"><label class="col-sm-3 col-form-label">comentario</label><div class="col-sm-7"><input id="comentario" type="text" class="form-control"></div></div>',              
                focusConfirm: false,
